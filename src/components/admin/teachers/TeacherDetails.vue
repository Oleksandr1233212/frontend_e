                                            ...
                                            <div class="col-lg-4 col-md-4">
                                                <div class="profile-user-box">
                                                    <div class="profile-user-img">
                                                        <img src="@/assets/img/avatar-18.jpg" alt="Profile">
                                                        <div
                                    ...
                                    <div class="student-personals-grp">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="personal-activity">
                                                    <div class="personal-icons">
                                                        <img src="@/assets/img/buliding-icon.svg" alt="">
                                                    </div>
                                                    <div class="views-personal">
                                                        <h4>Department </h4>
                                                        <h5>Electronics</h5>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="hello-park">
                                                    ...
                                                    <div class="educate-year">
                                                        <h6>2008 - 2009</h6>
                                                        <p>Secondary Schooling at xyz school of secondary education,
                                                            Mumbai.</p>
                                                    </div>
                                                    <div class="educate-year">
                                                        <h6>2011 - 2012</h6>
                                                    ...
                                                    <div class="educate-year">
                                                        <h6>2015 - 2017</h6>
                                                        <p class="mb-0">Master of Science at Cdm College of Engineering
                                                            and Technology, Pune.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
